...
%       At time step k+1, we need to forget old snapshot pair x(k-w), y(k-w), 
...
%       we should take xold = x(k-w), yold = y(k-w), xnew = x(k+1), ynew = y(k+1)
...
classdef WindowDMD < handle
    ...
    methods
        ...
        function update(obj, xold, yold, xnew, ynew)
            ...
            % xold = x(k-w), yold = y(k-w), xnew = x(k), ynew = y(k+1)
